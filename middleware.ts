...
export const config = {
  ...
  matcher: ['/((?!login|api/login|api/cache|api/cron|api/hub-toggle|api/board|api/survey|board|survey|share|hub|_next/static|_next/image|icon.png|apple-icon.png).*)'],
};
